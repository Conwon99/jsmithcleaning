              ...
              <div className="text-sm box-border caret-transparent flex flex-col leading-[20.3px] break-words w-full md:text-[17px] md:leading-[24.65px] md:w-1/2">
                <div className="text-sm box-border caret-transparent flex flex-col leading-[20.3px] break-words md:text-[17px] md:leading-[24.65px]">
                  <p className="text-sm text-neutral-700 box-border caret-transparent leading-[22px] break-words mb-4 md:text-[17px] md:leading-[24px]">
                    Professional driveway cleaning is essential for maintaining the appearance and value of your property. Your driveway is one of the first things visitors see, and a clean, well-maintained driveway creates a positive first impression.
                  </p>
                  <p className="text-sm text-neutral-700 box-border caret-transparent leading-[22px] break-words mb-4 md:text-[17px] md:leading-[24px]">
                    Our professional pressure washing service uses high-pressure equipment to effectively remove years of built-up dirt, oil stains, moss, and debris from your driveway. We can tackle even the toughest stains, leaving your driveway looking like new.
                  </p>
                  <p className="text-sm text-neutral-700 box-border caret-transparent leading-[22px] break-words mb-4 md:text-[17px] md:leading-[24px]">
