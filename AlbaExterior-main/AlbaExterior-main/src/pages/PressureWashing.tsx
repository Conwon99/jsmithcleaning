              ...
              <div className="text-sm box-border caret-transparent flex flex-col leading-[20.3px] break-words w-full md:text-[17px] md:leading-[24.65px] md:w-1/2">
                <div className="text-sm box-border caret-transparent flex flex-col leading-[20.3px] break-words md:text-[17px] md:leading-[24.65px]">
                  <p className="text-sm text-neutral-700 box-border caret-transparent leading-[22px] break-words mb-4 md:text-[17px] md:leading-[24px]">
                    High-pressure cleaning is the perfect solution for driveways, patios, and other hard surfaces that need a deep, thorough clean. Our professional pressure washing service effectively removes years of built-up dirt, grime, stains, and debris to restore your property's original appearance.
                  </p>
                  <p className="text-sm text-neutral-700 box-border caret-transparent leading-[22px] break-words mb-4 md:text-[17px] md:leading-[24px]">
                    Using professional-grade equipment, we can tackle even the toughest stains and restore your hard surfaces to their former glory. Whether it's oil stains on your driveway, moss on your patio, or general grime buildup, our pressure washing service will leave your surfaces looking like new.
                  </p>
                  <p className="text-sm text-neutral-700 box-border caret-transparent leading-[22px] break-words mb-4 md:text-[17px] md:leading-[24px]">
