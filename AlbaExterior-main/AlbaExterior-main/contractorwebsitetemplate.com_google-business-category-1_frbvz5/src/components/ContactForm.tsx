export const ContactForm = () => {
  return (
    <div className="relative box-border caret-transparent flex min-h-px w-full md:w-[39.956%]">
      <div className="relative content-start bg-[linear-gradient(160deg,rgb(0,0,0)_0%,rgb(8,8,8)_100%)] shadow-[rgba(0,0,0,0.5)_0px_0px_10px_0px] box-border caret-transparent flex flex-wrap w-full mt-0 p-5 rounded-lg border-[3px] border-solid border-white md:mt-[-60px]">
        <div className="absolute bg-zinc-600 box-border caret-transparent opacity-50 rounded-lg inset-0"></div>
        <div className="relative text-white text-[23px] font-bold box-border caret-transparent leading-[34.5px] text-center w-full mb-5 font-roboto md:text-3xl md:leading-[45px]">
          <div className="text-[23px] box-border caret-transparent leading-[34.5px] -mb-5 md:text-3xl md:leading-[45px] md:mb-0">
            <p className="text-[23px] box-border caret-transparent leading-[34.5px] mb-[14.4px] md:text-3xl md:leading-[45px]">
              Get A Free Estimate
            </p>
          </div>
        </div>
