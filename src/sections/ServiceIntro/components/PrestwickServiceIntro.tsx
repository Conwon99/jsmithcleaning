...
export const PrestwickServiceIntro = () => {
  const questions = [
    <>Is moss growing on your roof? We do <span className="text-[#17539B] font-semibold">roof cleaning</span> in Prestwick that removes moss and stops it coming back.</>,
              ...
              <div className="relative box-border caret-transparent flex flex-col md:flex-row gap-8 items-start">
                <div className="relative box-border caret-transparent flex flex-col w-full md:w-1/2">
                  <div className="relative box-border caret-transparent text-left w-full mb-6">
                    <h2 className="text-neutral-900 text-2xl font-bold not-italic box-border caret-transparent leading-8 font-thiccboi md:text-4xl md:leading-10">Who's the Best Exterior Cleaning Company Near Me in Prestwick?</h2>
                  </div>
