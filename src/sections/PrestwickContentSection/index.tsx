...
const LOC = "Prestwick";
const AREAS = "Prestwick, Ayr, and Monkton";
const WEATHER = "Near the airport, salt air and weather take a toll on Prestwick properties. Moss and algae build up on roofs";

export const PrestwickContentSection = () => (
    ...
    <div className="max-w-[1300px] mx-auto px-5">
      <div className="prose prose-lg max-w-none">
        ...
        <div className="space-y-8">
          ...
          <div><h2 className="text-neutral-900 text-2xl font-bold leading-8 mt-8 mb-4 font-thiccboi md:text-3xl md:leading-9">Pressure Washing</h2><p className="text-neutral-700 text-base leading-7 font-figtree md:text-lg md:leading-8 mb-4">Driveways get dirty. Patios get covered in algae. Pressure washing fixes all of this.</p><p className="text-neutral-700 text-base leading-7 font-figtree md:text-lg md:leading-8">We do pressure washing for driveways, patios, paths, and other hard surfaces around {LOC}. Your surfaces will look like new again.</p></div>
          ...
          <div><h2 className="text-neutral-900 text-2xl font-bold leading-8 mt-8 mb-4 font-thiccboi md:text-3xl md:leading-9">Gutter Cleaning</h2><p className="text-neutral-700 text-base leading-7 font-figtree md:text-lg md:leading-8 mb-4">Blocked gutters cause big problems. In {LOC}, keeping gutters clear is really important.</p><p className="text-neutral-700 text-base leading-7 font-figtree md:text-lg md:leading-8">We clean out all the leaves, moss, and debris. Regular gutter cleaning stops expensive problems later.</p></div>
          ...
          <div className="mt-12 p-6 bg-neutral-50 rounded-lg">
            ...
            <p className="text-neutral-700 text-base leading-7 font-figtree md:text-lg md:leading-8 mb-4">Prestwick's location near the airport and coast means salt air and moisture affect properties. Moss and algae grow fast here.</p>
            <p className="text-neutral-700 text-base leading-7 font-figtree md:text-lg md:leading-8 mb-4">We work all over {LOC} - Ayr, Monkton, and the surrounding areas. We know the local property types. We understand this.</p>
