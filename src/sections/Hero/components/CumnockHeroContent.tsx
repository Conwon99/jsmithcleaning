export const CumnockHeroContent = () => {
  return (
              ...
              <div className="relative text-sm box-border caret-transparent leading-[20.3px] break-words text-center md:text-[17px] md:leading-[24.65px]">
                ...
                <div className="relative text-white text-base box-border caret-transparent leading-6 text-center w-full mb-5 font-thiccboi md:text-lg md:leading-7">
                  <p className="text-base box-border caret-transparent leading-6 mb-[14.4px] md:text-lg md:leading-7 max-w-[600px] mx-auto">
                    East Ayrshire weather means moss and algae build up on roofs and gutters. We're the local team Cumnock homeowners trust for exterior cleaning. We do roof cleaning, pressure washing, soft washing, and gutter cleaning across Cumnock, Auchinleck, and Ochiltree.
                  </p>
                </div>
              </div>
            </div>
