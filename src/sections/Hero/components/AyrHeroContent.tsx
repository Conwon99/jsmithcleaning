                  ...
                  <div className="relative text-white text-base box-border caret-transparent leading-6 text-center w-full mb-5 font-thiccboi md:text-lg md:leading-7">
                    <div className="text-base box-border caret-transparent leading-6 ml-2.5 mt-2.5 md:text-lg md:leading-7">
                      <p className="text-base box-border caret-transparent leading-6 mb-[14.4px] md:text-lg md:leading-7 max-w-[600px] mx-auto">
                        Seaside weather means salt, moisture, and algae build up fast. We're the local team Ayr homeowners trust for exterior cleaning. We do roof cleaning, pressure washing, soft washing, and gutter cleaning across Ayr, Alloway, Prestwick, and Troon.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-sm box-border caret-transparent leading-[20.3px] break-words mb-5 mx-5 md:text-[17px] md:leading-[24.65px] before:accent-auto before:box-border before:caret-transparent before:text-black before:table before:text-sm before:not-italic before:normal-nums before:font-normal before:tracking-[normal] before:leading-[20.3px] before:list-outside before:list-disc before:break-words before:pointer-events-auto before:text-start before:indent-[0px] before:normal-case before:visible before:border-separate before:font-figtree before:md:text-[17px] before:md:leading-[24.65px] after:accent-auto after:box-border after:caret-transparent after:clear-both after:text-black after:table after:text-sm after:not-italic after:normal-nums after:font-normal after:tracking-[normal] after:leading-[20.3px] after:list-outside after:list-disc after:break-words after:pointer-events-auto after:text-start after:indent-[0px] after:normal-case after:visible after:border-separate after:font-figtree after:md:text-[17px] after:md:leading-[24.65px]">
                <div className="text-sm box-border caret-transparent leading-[20.3px] break-words text-center md:text-[17px] md:leading-[24.65px]">
                  ...
                  <div className="text-sm box-border caret-transparent flex items-center justify-center gap-3 mt-6 leading-[20.3px] break-words md:text-[17px] md:leading-[24.65px]">
                    <svg className="text-blue-600 w-7 h-7 box-border caret-transparent leading-[20.3px] break-words fill-current md:text-[17px] md:w-8 md:h-8 md:leading-[24.65px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" fill="currentColor" />
                    </svg>
                    <svg className="w-7 h-7 box-border caret-transparent leading-[20.3px] break-words md:text-[17px] md:w-8 md:h-8 md:leading-[24.65px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className="text-yellow-400 w-6 h-6 box-border caret-transparent leading-[20.3px] break-words fill-current md:text-[17px] md:w-7 md:h-7 md:leading-[24.65px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
