...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    description: "Professional PVC window, door, and frame cleaning combined with comprehensive gutter cleaning and maintenance services.",
  },
  {
    title: "SOFTWASHING",
    imageUrl: "/SOFTWASH1.jpeg",
