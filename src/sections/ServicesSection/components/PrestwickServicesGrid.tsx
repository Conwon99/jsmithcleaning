...
const services: ServiceGridItem[] = [
  ...
  { title: "PATIO CLEANING", imageUrl: "/services/patiocleaning.jpg", path: "/prestwick/patio-cleaning", description: "Professional patio cleaning to restore your outdoor living spaces. Removes moss, algae, and dirt for a like-new finish." },
  { title: "DRIVEWAY CLEANING", imageUrl: "/services/drivewaycleaning.png", path: "/prestwick/driveway-cleaning", description: "Expert driveway cleaning to remove oil stains, dirt, and grime. Enhances curb appeal and extends the life of your driveway." },
];
