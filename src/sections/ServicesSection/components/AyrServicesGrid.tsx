...
const services: ServiceGridItem[] = [
  { title: "ROOF CLEANING", imageUrl: "/services/roofcleaning.png", path: "/ayr/roof-cleaning", description: "Professional roof cleaning to remove moss, algae, and dirt, protecting your roof and enhancing your property's appearance." },
