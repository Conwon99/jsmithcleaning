...
export const HeroTestimonials = () => {
  const testimonials = [
    {
      name: "Sarah M.",
      text: "Fantastic pressure washing service! My driveway looks brand new. Very professional and polite team. Highly recommend J Smith Exterior Cleaning.",
    },
    {
      name: "David P.",
    ...
    {
      name: "Emma T.",
      text: "J Smith Exterior Cleaning did a brilliant job on my property. The pressure washing cleaned my driveways perfectly, and the softwashing made my walls look like new. Very courteous and professional. Would definitely use them again!",
    },
  ];
