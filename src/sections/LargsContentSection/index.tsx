...
const LOC = "Largs";
const AREAS = "Largs, Fairlie, Skelmorlie, and Wemyss Bay";
const WEATHER = "Coastal humidity and sea spray mean algae and moss thrive on Largs properties";

export const LargsContentSection = () => (
    ...
    <div className="max-w-[1300px] mx-auto px-5">
      <div className="prose prose-lg max-w-none">
        <div className="mb-8">
          ...
          <p className="text-neutral-700 text-base leading-7 font-figtree md:text-lg md:leading-8">We're J Smith Exterior Cleaning. We've been helping homeowners in {AREAS}, and the surrounding areas keep their properties looking good for years. We know the coastal weather. We know the common problems. And we know how to fix them.</p>
        </div>
        <div className="space-y-8">
          ...
          <div className="mt-12 p-6 bg-neutral-50 rounded-lg">
            ...
            <p className="text-neutral-700 text-base leading-7 font-figtree md:text-lg md:leading-8 mb-4">{WEATHER}. If you don't keep on top of cleaning, your property will look run down quickly. As a popular tourist destination, keeping your property looking its best matters.</p>
            <p className="text-neutral-700 text-base leading-7 font-figtree md:text-lg md:leading-8 mb-4">We work all over {LOC} - Fairlie, Skelmorlie, Wemyss Bay, and the surrounding areas. We know the local property types. We understand this.</p>
