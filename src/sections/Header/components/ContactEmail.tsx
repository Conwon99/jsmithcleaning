          ...
          <div className="text-sm box-border caret-transparent leading-[20.3px] break-words mb-5 mx-5 md:text-[17px] md:mb-0 md:mx-0 md:leading-[24.65px]">
            <div className="text-sm box-border caret-transparent leading-[20.3px] break-words flex justify-center md:text-[17px] md:justify-start md:leading-[24.65px]">
              <a
                ...
                className="relative text-white text-base font-bold box-border caret-transparent inline-flex items-center gap-2.5 justify-center tracking-wide leading-normal text-center align-middle bg-[#8dae23] hover:bg-[#7a9a1f] hover:shadow-lg transition-all overflow-hidden px-6 py-3.5 rounded-md shadow-lg whitespace-nowrap md:px-7 md:py-4"
                onClick={() => {
                  if (typeof window !== 'undefined' && window.gtag) {
                    window.gtag('event', 'quoteButton_nav', {
                      event_category: 'CTA',
                      event_label: 'Navigation Quote Button'
                    });
                  }
                }}
              >
