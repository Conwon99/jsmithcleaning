...
import { SecondaryNav } from "@/sections/Header/components/SecondaryNav";

export const Header = () => {
  return (
    <header
      role="banner"
      className="sticky top-0 z-50 text-sm box-border caret-transparent leading-[20.3px] break-words md:text-[17px] md:leading-[24.65px]"
    >
